...
import {adminEditArticleUsingPost, adminGetEditArticleByIdUsingGet} from "@/api/articleController.ts";
...
onMounted(async () => {
	...
	articleCategorySelect.value = editArticle.value.articleCategory
...
async function doEdit() {
	...
	editArticlePost.articleCategory = articleCategorySelect.value
